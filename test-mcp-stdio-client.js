...
/**
 * Test MCP Client using stdio transport
 *
 * This script connects to the Task Master MCP server via stdio and tests its functionality.
 * It will:
 * 1. Connect to the MCP server
 * 2. List available tools and resources
 * 3. Call the openDashboard tool to start the web interface
 */
...
async function main() {
  try {
    ...
    if (openDashboardTool) {
      console.log('\nStarting web interface using openDashboard tool...');
      ...
      console.log('\nKeeping the server running for 60 seconds...');
